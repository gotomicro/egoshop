...
(function(mod) {
            ...
            if (cmp(newPos, curPos) == 0) {
              ...
              if (!newPos) {
                if (flipped) {
                  ...
                  // Otherwise, turn off editing until further notice, and return the start of the docBefore
                  doc.cantEdit = true;
  ...
  // Used to add methods to editor and docBefore instances, wrapping them in
  // operations.
  function methodOp(f) {
    return function() {
  ...
  function makeChangeSingleDoc(doc, change, selAfter, spans) {
    ...
    // Clip the change to the size of this docBefore
