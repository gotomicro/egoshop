...
(function() {
  ...
  MT("eviltest",
     ...
     "          [def&variable fn:docSecond]()[[ [variable foo][keyword /][variable @bar] [keyword eq] [variable $let] ]],",
     ...
     "          [keyword attribute] [variable fn:docSecond] { [variable &quot;bar&quot;] [variable castable] [keyword as] [atom xs:string] },",
     "          [keyword element] [variable text] { [keyword text] { [variable &quot;text&quot;] } },",
     "          [def&variable fn:docSecond]()[[ [qualifier child::][variable eq][keyword /]([variable @bar] [keyword |] [qualifier attribute::][variable attribute]) [keyword eq] [variable $let] ]],",
     "          [keyword //][variable fn:docSecond]",
     "      }");
